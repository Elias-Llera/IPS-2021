 ...
 */
public class CarreraDisplayDTOEjemplo {
	private String id;
	private String descr;
	private String abierta;
	public CarreraDisplayDTOEjemplo() {}
	public CarreraDisplayDTOEjemplo(String rowId, String rowDescripcion, String rowEstado) {
		this.id=rowId;
